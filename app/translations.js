    ...
    $translateProvider
        .translations('en', {
            ...
            METER: {
              ...
              INPUT_HOURLY_LOW_LIMIT:'Input Hourly Low Limit',
              HOURLY_HIGH_LIMIT:'Hourly High Limit (Inclusive)',
              INPUT_HOURLY_HIGH_LIMIT:'Input Hourly High Limit',
              LOCATION:'Location',
              INPUT_LOCATION:'Input Location',
              DESCRIPTION:'Description',
              INPUT_DESCRIPTION:'Input Description',
        ...
        .translations('cn', {
            ...
            STORE: {
              ...
              INPUT_ADDRESS:'输入地址',
              INPUT_LATITUDE:'输入纬度',
              INPUT_LONGITUDE:'输入经度',
              INPUT_DESCRIPTION:'输入描述',
            },
            METER: {
              HOURLY_LOW_LIMIT:'每小时最小值（包含）',
              INPUT_HOURLY_LOW_LIMIT:'输入每小时最小值',
              HOURLY_HIGH_LIMIT:'每小时最大值（包含）',
              INPUT_HOURLY_HIGH_LIMIT:'输入每小时最大值',
              LOCATION:'位置',
              INPUT_LOCATION:'输入位置',
              DESCRIPTION:'描述',
              INPUT_DESCRIPTION:'输入描述',
